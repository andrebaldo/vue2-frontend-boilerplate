<template>
  <v-container grid-list-xs>
    <v-stepper v-model="step">
      <v-stepper-header>
        <v-stepper-step :complete="step > 1" step="1">Title</v-stepper-step>
        <v-divider></v-divider>
        <v-stepper-step step="2">Pictures</v-stepper-step>
      </v-stepper-header>
      <v-stepper-items>
        <v-stepper-content step="1" class="pa-0">
          <Advertisement v-on:set-step="setStep" :nextStep="2" ref="advertisement" />
        </v-stepper-content>
